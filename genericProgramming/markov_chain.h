...
typedef void* Data; // the data of the MarkoveNode
typedef void (*PrintData)(Data); // function that gets data and prints it
// function that gets to data objects, compare them and return it
typedef int(*DataCmp)(Data, Data);
// function that gets data and execute allocation free
typedef void (*FreeData)(Data);
// function that gets Data object copy it and return the copy
typedef Data (*DataCpy)(Data);
// function that gets Data object, returns true if is last in chain, else true
typedef bool (*IsLast)(Data);
...
typedef struct MarkovChain {
    ...
    //   and returns:    - true if it's the last state.
    //      - false otherwise.
    IsLast is_last;
} MarkovChain;
